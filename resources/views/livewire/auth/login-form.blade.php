    ...
    <form wire:submit.prevent='login'>
        ...
        <div class="grid gap-y-4">
            ...
            <button type="submit"
                ...
                <div class="animate-spin inline-block size-4 border-[3px] border-current border-t-transparent text-gray-800 rounded-full dark:text-white" role="status" aria-label="loading" wire:loading>
